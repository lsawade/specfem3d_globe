...
! reads in file with all mesh parameters
  ...
  use shared_parameters, only: LOCAL_PATH,SIMULATION_TYPE,SAVE_FORWARD, &
    ...
    OCEANS,ROTATION,FULL_GRAVITY,SAVE_GREEN_FUNCTIONS
  ...
  if (SAVE_GREEN_FUNCTIONS .or. SIMULATION_TYPE /= 1 .or. SAVE_FORWARD .or. (MOVIE_VOLUME .and. SIMULATION_TYPE /= 3)) then
